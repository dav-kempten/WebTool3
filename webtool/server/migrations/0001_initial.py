# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-10-12 16:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('deprecated', models.BooleanField(default=False, verbose_name='Element gilt als gelöscht')),
                ('name', server.models.fields.TitleField(db_index=True, help_text='Ungefährer Zeitpunkt', max_length=30, unique=True, verbose_name='Kurzbeschreibung')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('deprecated', models.BooleanField(default=False, verbose_name='Element gilt als gelöscht')),
                ('code', models.CharField(help_text='Kurzzeichen der Kategorie', max_length=3, unique=True, verbose_name='Kurzzeichen')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('deprecated', models.BooleanField(default=False, verbose_name='Element gilt als gelöscht')),
                ('code', models.CharField(help_text='Kurzzeichen für die Ausrüstung', max_length=10, unique=True, verbose_name='Kurzzeichen')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('deprecated', models.BooleanField(default=False, verbose_name='Element gilt als gelöscht')),
                ('code', models.CharField(help_text='Konditionelle Anforderungen', max_length=3, unique=True, verbose_name='Kurzbeschreibung')),
                ('order', server.models.fields.OrderField(blank=True, db_index=True, default=0, help_text='Reihenfolge in der Druckausgabe', verbose_name='Reihenfolge')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('updated', models.DateTimeField(auto_now=True)),
                ('deprecated', models.BooleanField(default=False, verbose_name='Element gilt als gelöscht')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, primary_key=True, related_name='guide', serialize=False, to=settings.AUTH_USER_MODEL, verbose_name='Leiter')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('deprecated', models.BooleanField(default=False, verbose_name='Element gilt als gelöscht')),
                ('name', server.models.fields.NameField(help_text='Bezeichnung des Abschnitts', max_length=125, unique=True, verbose_name='Bezeichnung')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('deprecated', models.BooleanField(default=False, verbose_name='Element gilt als gelöscht')),
                ('code', models.CharField(help_text='Technische Anforderungen', max_length=3, unique=True, verbose_name='Kurzbeschreibung')),
                ('order', server.models.fields.OrderField(blank=True, db_index=True, default=0, help_text='Reihenfolge in der Druckausgabe', verbose_name='Reihenfolge')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skill', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='description_list', to='server.Skill', verbose_name='Technische Anforderung')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('deprecated', models.BooleanField(default=False, verbose_name='Element gilt als gelöscht')),
                ('name', server.models.fields.TitleField(help_text='Bearbeitungsstand', max_length=30, unique=True, verbose_name='Kurzbeschreibung')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('updated', models.DateTimeField(auto_now=True)),
                ('deprecated', models.BooleanField(default=False, verbose_name='Element gilt als gelöscht')),
                ('season', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, primary_key=True, related_name='calendar', serialize=False, to='server.Season', verbose_name='Saison')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='topic',
            name='seasons',
            field=models.ManyToManyField(db_index=True, related_name='topic_list', to='server.Season', verbose_name='Saison'),
        ),
        migrations.AddField(
            model_name='topic',
            name='tariffs',
        ...
        migrations.AddField(
            model_name='tariff',
            name='season',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='tariff_list', to='server.Season', verbose_name='Saison'),
        ),
        migrations.AddField(
            model_name='state',
            name='seasons',
            field=models.ManyToManyField(db_index=True, related_name='state_list', to='server.Season', verbose_name='Saison'),
        ),
        migrations.AddField(
            model_name='skill',
            name='seasons',
            field=models.ManyToManyField(db_index=True, related_name='skill_list', to='server.Season', verbose_name='Saison'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='reference',
            name='season',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='reference_list', to='server.Season', verbose_name='Saison'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='part',
            name='seasons',
            field=models.ManyToManyField(db_index=True, related_name='part_list', to='server.Season', verbose_name='Saison'),
        ),
        migrations.AddField(
            model_name='guide',
            name='seasons',
            field=models.ManyToManyField(db_index=True, related_name='guide_list', to='server.Season', verbose_name='Saison'),
        ),
        migrations.AddField(
            model_name='fitness',
            name='seasons',
            field=models.ManyToManyField(db_index=True, related_name='fitness_list', to='server.Season', verbose_name='Saison'),
        ),
        migrations.AddField(
            model_name='equipment',
            name='seasons',
            field=models.ManyToManyField(db_index=True, related_name='equipment_list', to='server.Season', verbose_name='Saison'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='collective',
            name='seasons',
            field=models.ManyToManyField(db_index=True, related_name='collective_list', to='server.Season', verbose_name='Saison'),
        ),
        migrations.AddField(
            model_name='collective',
            name='section',
        ...
        migrations.AddField(
            model_name='category',
            name='seasons',
            field=models.ManyToManyField(db_index=True, related_name='category_list', to='server.Season', verbose_name='Saison'),
        ),
        migrations.AddField(
            model_name='approximate',
            name='seasons',
            field=models.ManyToManyField(db_index=True, related_name='approximate_list', to='server.Season', verbose_name='Saison'),
        ),
        migrations.CreateModel(
            name='Instruction',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admission', server.models.fields.AdmissionField(blank=True, decimal_places=2, default=0.0, help_text='Teilnehmerbeitrag in €', max_digits=6, verbose_name='Beitrag für Mitglieder')),
                ('min_quantity', models.PositiveIntegerField(blank=True, default=0, help_text='Wieviel Teilnehemr müssen mindestens teilnehmen', verbose_name='Min. Tln')),
                ('max_quantity', models.PositiveIntegerField(help_text='Wieviel Teilnehemr können maximal teilnehmen', verbose_name='Max. Tln')),
                ('cur_quantity', models.PositiveIntegerField(blank=True, default=0, help_text='Wieviel Teilnehemr sind aktuell angemeldet', verbose_name='Anmeldungen')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='vacation',
            name='calendar',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='vacation_list', to='server.Calendar', verbose_name='Kalender'),
        ),
        ...
        migrations.AlterUniqueTogether(
            name='topic',
            unique_together=set([('title', 'internal')]),
        ),
        migrations.AlterUniqueTogether(
            name='tariff',
        ...
        migrations.AlterUniqueTogether(
            name='skilldescription',
            unique_together=set([('skill', 'category')]),
        ),
        migrations.AlterUniqueTogether(
            name='section',
            unique_together=set([('part', 'name')]),
        ),
        migrations.AlterUniqueTogether(
            name='reference',
        ...
        migrations.AlterUniqueTogether(
            name='fitnessdescription',
            unique_together=set([('fitness', 'category')]),
        ),
        migrations.AddField(
            model_name='event',
            name='approximate',
        ...
        migrations.AddField(
            model_name='event',
            name='season',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='event_list', to='server.Season', verbose_name='Saison'),
        ),
        migrations.AlterUniqueTogether(
            name='equipment',
        ...
        migrations.AddField(
            ...
            name='calendars',
            field=models.ManyToManyField(db_index=True, related_name='anniversary_list', to='server.Calendar', verbose_name='Kalender'),
        ),
        migrations.AlterUniqueTogether(
            name='vacation',
        ...
        migrations.AddField(
            model_name='tour',
            name='season',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='tour_list', to='server.Season', verbose_name='Saison'),
        ),
        migrations.AddField(
            model_name='tour',
            name='skill',
        ...
        migrations.AddField(
            model_name='talk',
            name='season',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='talk_list', to='server.Season', verbose_name='Saison'),
        ),
        migrations.AddField(
            model_name='talk',
            name='state',
        ...
        migrations.AlterUniqueTogether(
            name='anniversary',
            unique_together=set([('name', 'public_holiday')]),
        ),
    ]
