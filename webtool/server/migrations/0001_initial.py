# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-10-02 14:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget_info', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict)),
        ...
        migrations.AlterUniqueTogether(
            name='equipment',
            unique_together=set([('season', 'name'), ('season', 'code')]),
        ),
        migrations.AlterUniqueTogether(
            name='collective',
        ...
        migrations.AlterUniqueTogether(
            name='category',
            unique_together=set([('season', 'code', 'name'), ('season', 'code')]),
        ),
        migrations.AlterUniqueTogether(
            name='approximate',
            unique_together=set([('season', 'name')]),
