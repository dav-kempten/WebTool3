# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-10-01 16:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member_id', models.CharField(blank=True, help_text='Format:sss-oo-mmmmmm s=Sektionsnummer(008) o=Ortsgruppe(00|01) m=Mitgliedsnummer', max_length=13, null=True, unique=True, validators=[django.core.validators.RegexValidator(re.compile('\\d{3}-\\d{2}-\\d{6}', 32), 'Bitte auf den richtigen Aufbau achten')], verbose_name='MitgliedsNr')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('deprecated', models.BooleanField(default=False, verbose_name='Element gilt als gelöscht')),
                ('code', models.CharField(db_index=True, help_text='Kurzzeichen der Qualifikation', max_length=10, unique=True, verbose_name='Kurzzeichen')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='event_list', to='server.Category', verbose_name='Kategorie')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('params', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default={'accommodation_cost_default': 40.0, 'climbing_shool_part_id': 0, 'talk_categories': 'tlk', 'tour_calulation': {'half_tour_day_compensation': 20.0, 'min_admission': 5.0, 'whole_tour_day_compensation': 30.0}, 'travel_cost_factor': 0.07, 'youth_part_id': 0}, null=True)),
            ],
            options={
                'verbose_name': 'Saison',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('note', models.TextField(blank=True, default='', help_text='Raum für interne Notizen', verbose_name='Notizen')),
                ('qualification', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='qualification_list', to='server.Qualification')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('updated', models.DateTimeField(auto_now=True)),
                ('deprecated', models.BooleanField(default=False, verbose_name='Element gilt als gelöscht')),
                ('mileage', models.PositiveIntegerField(blank=True, default=0, help_text='Kempten (Treffpunkt) → Ausgangsort und zurück', verbose_name='Kilometerleistung')),
                ...
                ('budget_info', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default='')),
        ...
        migrations.AddField(
            model_name='event',
            name='reference',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='event_list', to='server.Reference', verbose_name='Buchungscode'),
        ),
        migrations.AddField(
            model_name='event',
            name='season',
        ...
        migrations.AlterUniqueTogether(
            name='reference',
            unique_together=set([('season', 'reference', 'category')]),
        ),
        migrations.AlterUniqueTogether(
            name='qualification',
        ...
        migrations.AlterUniqueTogether(
            name='guide',
            unique_together=set([('season', 'first_name', 'last_name')]),
        ),
        migrations.AlterUniqueTogether(
            name='fitnessdescription',
        ...
        migrations.AlterUniqueTogether(
            name='collective',
            unique_together=set([('season', 'title', 'name')]),
        ),
        migrations.AlterUniqueTogether(
            name='chapter',
